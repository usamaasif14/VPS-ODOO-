...
class TestPayslipValidation(TestPayslipValidationCommon):
    ...
    def test_n1_holiday_pay_recovery_40_hours_working_schedule(self):
        ...
        payslip_results_feb = {'BASIC': 3299.2, 'HolPayRecN1': -824.8, 'ATN.INT': 5.0, 'ATN.MOB': 4.0, 'SALARY': 2483.4, 'ONSS': -324.58, 'EmpBonus.A': 0.0, 'EmpBonus.B': 0.0, 'EmpBonus.1': 0.0, 'ONSSTOTAL': 324.58, 'ATN.CAR': 161.5, 'GROSSIP': 2320.32, 'IP.PART': -824.8, 'GROSS': 1495.52, 'P.P': -31.03, 'PPTOTAL': 31.03, 'ATN.CAR.2': -161.5, 'ATN.INT.2': -5.0, 'ATN.MOB.2': -4.0, 'M.ONSS': -22.53, 'MEAL_V_EMP': -16.35, 'REP.FEES': 150.0, 'IP': 824.8, 'IP.DED': -61.86, 'NET': 2168.05, 'REMUNERATION': 2474.4, 'ONSSEMPLOYERBASIC': 620.85, 'ONSSEMPLOYERCPAE': 5.71, 'ONSSEMPLOYERFFE': 0.04, 'ONSSEMPLOYERMFFE': 4.22, 'ONSSEMPLOYERRESTREINT': 41.97, 'ONSSEMPLOYERUNEMP': 2.48, 'ONSSEMPLOYER': 675.28, 'CO2FEE': 33.22}
