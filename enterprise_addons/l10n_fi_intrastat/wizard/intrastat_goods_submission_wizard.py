...
class L10n_Fi_IntrastatIntrastatGoodsSubmissionWizard(models.TransientModel):
    _name = 'l10n_fi_intrastat.intrastat.goods.submission.wizard'
    ...
    def print_csv(self):
        ...
        return {
            ...
            'data': {
                ...
                'file_generator': 'fi_intrastat_export_to_csv',
